...
from LearningToSample.src.distributions import BayesLogRegPost, Heart
...
def main(args):
    ...
    dist = Heart(X_train, y_train, X_test, y_test, args.prior)
    dist_irr = Heart(X_train, y_train, X_test, y_test, args.prior)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--logdir', type=str, default='logs/nice/logistic/heart')
