...
# from LearningToSample.src.NICE_MC.irr_nice_sampler import NiceSampler
...
if __name__ == '__main__':
    ...
    parser.add_argument('--means', nargs='+', type=list,
                        default=[[2.0, 0.0], [-2.0, 0.0]], help='mog means')
    parser.add_argument('--stds', nargs='+', default=[[0.5, 0.5], [0.5, 0.5]],
